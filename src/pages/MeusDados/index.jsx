...
export default function MeusDados() {
    ...
    if (isLoading) return <MeusDadosSkeleton />;
            ...
            <>
                <div className="flex justify-center items-center bg-[url('./assets/fundo_bolas_laranja_v2.svg')] bg-no-repeat bg-cover bg-opacity-50 py-10">
                    <div className="w-full max-w-4xl border-4 p-10 shadow-xl rounded-2xl gradiente mx-4">
                        <h2>
                            <span className="text-black text-xl mb-4">{dados.nome}</span>
                        </h2>
                            ...
                            <div className="flex gap-4">
                                ...
                                {recuperarSenhaModal && (
                                    <Modal setIsActive={setRecuperarSenhaModal}>
                                        <FormRecuperarSenha user={user} callback={() => setRecuperarSenhaModal(false)} />
                                    </Modal>
                                )}
                            </div>
                        </div>
